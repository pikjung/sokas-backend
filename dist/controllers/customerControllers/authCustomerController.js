...
const authCustomerController = {
    login(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const passwordMatch = yield bcrypt_1.default.compare(password, store.password);
            if (!passwordMatch)
                return res
                    .status(401)
                    .json((0, responseJson_1.default)("error", {}, "Invalid Password"));
            const token = jsonwebtoken_1.default.sign({ user_id: store.id, role: 'store' }, config_1.default.jwtSecret, {
                expiresIn: "2h",
            });
            res.status(200).json((0, responseJson_1.default)("success", token, "berhasil login"));
        });
    },
    verifyToken(req, res) {
        var _a;
...
exports.default = authCustomerController;
